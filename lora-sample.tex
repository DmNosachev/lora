...
\ExplSyntaxOn
\NewDocumentCommand{\aalttest}{}
 {
  \tl_set:Nn \l_tmpa_tl { AOŞŢaioşţҒДҘЛФбвгғджзҙиѝйклнптчцшщъью.,;·\#ƒ§¢¤\$€₴₺₽£₸₮¥+−×÷=≠><≥≤±≈¬\%0566789Ҫҫ:1234 }
  \tl_map_inline:Nn \l_tmpa_tl
   {
    \textcolor{gray}{##1}~
    {\fontspec[RawFeature={+aalt=1}]{Lora} ##1}~
   }
 }
\ExplSyntaxOff
...
\section{Access All Alternates (\texttt{aalt})}
...
\displayfonttable[color=BrickRed]{Lora.ttf}
